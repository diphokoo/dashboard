...
(function (global, factory) {
  ...
  var TemplateFactory__default =
  /*#__PURE__*/
  _interopDefaultLegacy(TemplateFactory);
  /**
   * --------------------------------------------------------------------------
    ...
    _createClass(Tooltip, [{
      ...
      value: function _getTemplateFactory(content) {
        if (this._templateFactory) {
          ...
          this._templateFactory = new TemplateFactory__default["default"](_objectSpread({}, this._config, {
