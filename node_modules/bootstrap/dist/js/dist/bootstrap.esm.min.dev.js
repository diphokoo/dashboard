...
var MAX_UID = 1e6,
  ...
  t = function t() {
    ...
    try {
      for (var _iterator2 = DOMContentLoadedCallbacks[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function removeNamespacedHandlers(e, t, n, i) {
  ...
  for (var _i2 = 0, _Object$keys = Object.keys(s); _i2 < _Object$keys.length; _i2++) {
    var o = _Object$keys[_i2];

    if (o.includes(i)) {
      var _i3 = s[o];
      removeHandler(e, t, n, _i3.callable, _i3.delegationSelector);
    }
  }
}
...
var EventHandler = {
  ...
  off: function off(e, t, n, i) {
    ...
    if (void 0 === o) {
      if (_) {
        for (var _i4 = 0, _Object$keys2 = Object.keys(l); _i4 < _Object$keys2.length; _i4++) {
          var _n2 = _Object$keys2[_i4];
          removeNamespacedHandlers(e, l, _n2, t.slice(1));
        }
      }

      for (var _i5 = 0, _Object$keys3 = Object.keys(c); _i5 < _Object$keys3.length; _i5++) {
        var _n3 = _Object$keys3[_i5];

        var _i6 = _n3.replace(stripUidRegex, "");
...
function () {
  ...
  _createClass(Config, [{
    ...
    value: function _typeCheckConfig(e) {
      ...
      for (var _i8 = 0, _Object$keys4 = Object.keys(t); _i8 < _Object$keys4.length; _i8++) {
        var i = _Object$keys4[_i8];
        var s = t[i],
            o = e[i],
...
function (_Config) {
  ...
  _createClass(BaseComponent, [{
    ...
    value: function dispose() {
      ...
      try {
        for (var _iterator5 = Object.getOwnPropertyNames(this)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          var e = _step5.value;
          this[e] = null;
        }
      } catch (err) {
...
function (_BaseComponent3) {
  ...
  _createClass(Carousel, [{
    ...
    value: function _addTouchEventListeners() {
      ...
      try {
        for (var _iterator6 = SelectorEngine.find(SELECTOR_ITEM_IMG, this._element)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
          var _e4 = _step6.value;
          EventHandler.on(_e4, EVENT_DRAG_START, function (e) {
...
function (_BaseComponent4) {
  ...
  function Collapse(e, t) {
    ...
    try {
      for (var _iterator8 = n[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        ...
        null !== _t3 && _n5.length && _this12._triggerArray.push(_e5);
      }
    } catch (err) {
  ...
  _createClass(Collapse, [{
    ...
    value: function hide() {
      ...
      try {
        for (var _iterator10 = this._triggerArray[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
    ...
    value: function show() {
      ...
      if (!EventHandler.trigger(this._element, EVENT_SHOW$5, e).defaultPrevented) {
        if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav")) {
          ...
          try {
            for (var _iterator14 = (_ref4 = []).concat.apply(_ref4, _toConsumableArray(document.body.children))[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
              var _ref4;
    ...
    value: function _completeHide(e) {
      if (!EventHandler.trigger(this._element, EVENT_HIDE$5, e).defaultPrevented) {
        if ("ontouchstart" in document.documentElement) {
          ...
          try {
            for (var _iterator15 = (_ref5 = []).concat.apply(_ref5, _toConsumableArray(document.body.children))[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
              var _ref5;
  ...
  _createClass(ScrollBarHelper, [{
    ...
    value: function _applyManipulationCallback(e, t) {
      if (isElement(e)) t(e);else {
        ...
        try {
          for (var _iterator17 = SelectorEngine.find(e, this._element)[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
...
function (_Config3) {
  ...
  function Backdrop(e) {
    ...
    _this18 = _possibleConstructorReturn(this, _getPrototypeOf(Backdrop).call(this)), _this18._config = _this18._getConfig(e), _this18._isAppended = !1, _this18._element = null;
    return _this18;
  }
...
function (_Config4) {
  ...
  function FocusTrap(e) {
    ...
    _this21 = _possibleConstructorReturn(this, _getPrototypeOf(FocusTrap).call(this)), _this21._config = _this21._getConfig(e), _this21._isActive = !1, _this21._lastTabNavDirection = null;
    return _this21;
  }
...
function (_BaseComponent6) {
  ...
  _createClass(Modal, [{
    ...
    key: "dispose",
    value: function dispose() {
      for (var _i9 = 0, _arr2 = [window, this._dialog]; _i9 < _arr2.length; _i9++) {
        var e = _arr2[_i9];
...
EventHandler.on(document, EVENT_CLICK_DATA_API$1, SELECTOR_DATA_TOGGLE$1, function (e) {
  ...
  try {
    for (var _iterator18 = SelectorEngine.find(OPEN_SELECTOR)[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
      var e = _step18.value;
  ...
  try {
    for (var _iterator19 = SelectorEngine.find("[aria-modal][class*=show][class*=offcanvas-]")[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
      var e = _step19.value;
...
function sanitizeHtml(e, t, n) {
  ...
  try {
    for (var _iterator20 = s[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
      ...
      var _n9 = _e13.nodeName.toLowerCase();
      ...
      var _i10 = (_ref8 = []).concat.apply(_ref8, _toConsumableArray(_e13.attributes)),
          _s2 = [].concat(t["*"] || [], t[_n9] || []);
      ...
      try {
        for (var _iterator21 = _i10[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
          var _t6 = _step21.value;
          allowedAttribute(_t6, _s2) || _e13.removeAttribute(_t6.nodeName);
        }
      } catch (err) {
...
function (_Config5) {
  ...
  _createClass(TemplateFactory, [{
    ...
    value: function _checkContent(e) {
      for (var _i12 = 0, _Object$entries3 = Object.entries(e); _i12 < _Object$entries3.length; _i12++) {
        var _Object$entries3$_i = _slicedToArray(_Object$entries3[_i12], 2),
            t = _Object$entries3$_i[0],
            _n11 = _Object$entries3$_i[1];
  ...
  _createClass(Tooltip, [{
    ...
    value: function show() {
      ...
      if (this._element.ownerDocument.documentElement.contains(this.tip) || (i.append(n), EventHandler.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(n), n.classList.add("show"), "ontouchstart" in document.documentElement) {
        ...
        try {
          for (var _iterator22 = (_ref9 = []).concat.apply(_ref9, _toConsumableArray(document.body.children))[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
            var _ref9;
    ...
    value: function hide() {
      ...
      if (this._isShown() && !EventHandler.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) {
        if (this._getTipElement().classList.remove("show"), "ontouchstart" in document.documentElement) {
          ...
          try {
            for (var _iterator23 = (_ref10 = []).concat.apply(_ref10, _toConsumableArray(document.body.children))[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
              var _ref10;
      ...
      try {
        for (var _iterator24 = e[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
          ...
          if ("click" === t) EventHandler.on(this._element, this.constructor.eventName("click"), this._config.selector, function (e) {
            ...
            EventHandler.on(this._element, _e15, this._config.selector, function (e) {
    ...
    value: function _getConfig(e) {
      ...
      for (var _i13 = 0, _Object$keys5 = Object.keys(t); _i13 < _Object$keys5.length; _i13++) {
        var _e16 = _Object$keys5[_i13];
...
function (_BaseComponent9) {
  ...
  _createClass(ScrollSpy, [{
    ...
    value: function refresh() {
      ...
      try {
        for (var _iterator25 = this._observableSections.values()[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
          var e = _step25.value;
    ...
    value: function _maybeEnableSmoothScroll() {
      ...
      this._config.smoothScroll && (EventHandler.off(this._config.target, EVENT_CLICK), EventHandler.on(this._config.target, EVENT_CLICK, "[href]", function (e) {
        ...
        if (t) {
          ...
          var _n13 = _this48._rootElement || window,
              i = t.offsetTop - _this48._element.offsetTop;

          if (_n13.scrollTo) return void _n13.scrollTo({
            top: i,
            behavior: "smooth"
          });
          _n13.scrollTop = i;
    ...
    value: function _initializeTargetsAndObservables() {
      ...
      try {
        for (var _iterator27 = e[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
          var t = _step27.value;
    ...
    value: function _activateParents(e) {
      if (e.classList.contains("dropdown-item")) SelectorEngine.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add("active");else {
        ...
        try {
          for (var _iterator28 = SelectorEngine.parents(e, ".nav, .list-group")[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
            var t = _step28.value;
            ...
            try {
              for (var _iterator29 = SelectorEngine.prev(t, SELECTOR_LINK_ITEMS)[Symbol.iterator](), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
...
EventHandler.on(window, EVENT_LOAD_DATA_API$1, function () {
  ...
  try {
    for (var _iterator31 = SelectorEngine.find(SELECTOR_DATA_SPY)[Symbol.iterator](), _step31; !(_iteratorNormalCompletion31 = (_step31 = _iterator31.next()).done); _iteratorNormalCompletion31 = true) {
      var e = _step31.value;
...
function (_BaseComponent10) {
  ...
  _createClass(Tab, [{
    ...
    value: function _activate(e, t) {
      ...
      e && (e.classList.add("active"), this._activate(getElementFromSelector(e)), this._queueCallback(function () {
    ...
    value: function _deactivate(e, t) {
      ...
      e && (e.classList.remove("active"), e.blur(), this._deactivate(getElementFromSelector(e)), this._queueCallback(function () {
    ...
    value: function _toggleDropDown(e, t) {
      ...
      var i = function i(e, _i14) {
        var s = SelectorEngine.findOne(e, n);
        s && s.classList.toggle(_i14, t);
      };
...
EventHandler.on(document, "click.bs.tab", SELECTOR_DATA_TOGGLE, function (e) {
  ...
  try {
    for (var _iterator33 = SelectorEngine.find(SELECTOR_DATA_TOGGLE_ACTIVE)[Symbol.iterator](), _step33; !(_iteratorNormalCompletion33 = (_step33 = _iterator33.next()).done); _iteratorNormalCompletion33 = true) {
      var e = _step33.value;
